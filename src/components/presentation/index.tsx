      ...
      >
        <div className='w-full flex lg:items-center lg:justify-center'>
          <div className={`flex flex-col gap-4 mb-6 lg:w-[754px] lg:pb-[32px] lg:pt-[199px] lg-plus:pb-[130px] `}>
            <div>
              <h1 className='w-full max-w-[383px] text-white text-xl font-bold md:text-[42px] md:w-[550px] md:max-w-[550px] md:leading-relaxed'>
                Ganhe{' '}
            ...
            <p className='w-full max-w-[321px] text-base text-gray-200 leading-[1.5] md:text-2xl  md:max-w-[650px] lg-w-full md:tracking-tight md:leading-[2.3rem]'>
            ...
            <a className='w-full max-w-[343px] sm-min:w-[343px] h-[69px] mt-4 p-0 lg:w-[404px]' href='#'>
              <Button className='text-[22px]' text='Quero participar' />
            </a>
          </div>

          <div className='hidden lg:flex animate-move-up-down'>
            <Image className='max-w-[520px] lg:w-[400px]' src={curvedRender} alt='Curved Render' />
          </div>
        </div>
      </section>
    </>
